        ...
        children: [
          ...
          },
          {
            ...
            steps: [
              ...
              {
                title: '新建/编辑算法',
                content: '设置算法名称与说明，调整权重参数：基础分、老化/连续无成交/曝光(7天)/浏览(7天)/咨询(7天)/成交(7天)/转化率(7天)/想要增速(7天)各信号权重、擦亮保护、下架分数线、归一化方式（百分位/对数）、无数据商品策略、硬排开关与选取方式。'
              },
              {
                title: '选择选取方式',
              ...
              {
                title: '预览算法效果',
                content: '点击算法行的「效果」按钮，查看该算法对当前账号全部在售商品的下架权重排名：每行展示逐项分值构成（基础/老化/无成交/曝光(7天)/浏览(7天)/咨询(7天)/成交(7天)/转化(7天)/想要(7天)/擦亮）与信号徽章（真实上架天数/连续无成交天数/7天曝光/7天浏览/7天咨询/7天成交/7天转化/7天想要增速/已擦亮）。'
              },
              {
                title: '查看引用规则',
            ...
            tips: [
              '各信号在账号内先归一化（百分位，越接近1代表该指标越高），再乘以对应权重计入总分；曝光/浏览/咨询/成交/转化/想要增速为反向信号（指标越低分越高），老化与连续无成交为正向信号（越高分越高）',
